...
Before suggesting or editing project-specific code, use budget-aware memory reading:
...
- Recommend `guardian-cmd guardian-verify` before committing when available; otherwise recommend `guardian verify`.
